...
export default function Migrate() {
  ...
  return (
    <Container id="migrate-page" className="py-4 mx-auto space-y-6 md:py-8 lg:py-12" maxWidth="2xl">
      <Head>
        <title>Migrate | Memeswap</title>
        <meta key="description" name="description" content="Migrate your liquidity to Memeswap." />
        <meta key="twitter:description" name="twitter:description" content="Migrate your liquidity to Memeswap." />
        <meta key="og:description" property="og:description" content="Migrate your liquidity to Memeswap." />
      </Head>
      ...
      {!account ? (
        <Web3Connect className="w-full !bg-dark-900 bg-gradient-to-r from-opaque-blue/80 hover:from-opaque-blue to-green/80 hover:to-green text-white h-[38px]" />
      ) : (
